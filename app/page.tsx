      ...
      <div className="relative min-h-screen flex items-center justify-center pt-16">
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(circle at 20% 10%, rgba(59,130,246,0.28), transparent 55%), radial-gradient(circle at 80% 30%, rgba(34,211,238,0.18), transparent 52%), radial-gradient(circle at 50% 80%, rgba(16,185,129,0.14), transparent 60%)',
            }}
          />
